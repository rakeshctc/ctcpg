<%@ Page Title="" Language="C#" MasterPageFile="~/CTCMaster.Master" AutoEventWireup="true" CodeBehind="JustToConfirm.aspx.cs" Inherits="CTC_Final.JustToConfirm" %>
    ...
    <script>
        jquery104min(function () {
            ...
            if ($("[id$=HiddenField1]").attr("Value").length > 0) {
                $("[id$=txtUDOB]").datepicker("setDate", new Date($("[id$=HiddenField1]").attr("Value")));
            }
        });
    </script>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12" style="margin-left: -120px; margin-bottom: 10px">
                            ...
                            <div class="col-xs-12 col-md-6" style="text-align: left">
                                ...
                                <input type="text" runat="server" visible="false" name="order_id" value="123454789" readonly="true" />
                                <input type="text" runat="server" visible="false" name="amount" value="1.00" />
                                <input type="text" runat="server" visible="false" name="currency" value="INR" />
                                <input type="text" runat="server" visible="false" name="redirect_url" value="http://192.168.0.89/MCPG.ASP.net.2.0.kit/ccavResponseHandler.aspx" />
                                <input type="text" runat="server" visible="false" name="cancel_url" value="http://www.chennaitrekkingclubevents.org/support.aspx" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div id="divNextPreviousButton" runat="server">
                        <div class="row col-md-12">
                            <div class=" col-md-3 col-md-offset-2">
                                ...
                                <asp:Button ID="btnEditData" class="btn btn-primary btn-large btn-block col-md-3" runat="server" Text="Edit Given Data" OnClick="btnEditData_Click" />
                            </div>
                            <div class="col-md-3 col-md-offset-2">
                        ...
                        <div class="col-xs-12 col-md-12" style="margin-left: -150px; margin-bottom: 10px">
                            ...
                            <div class="col-xs-12 col-md-3" style="text-align: left">
                                <asp:DropDownList ID="ddlUTshirt" Width="255px" runat="server" CssClass="validate[required] form-control login-field">
                                    ...
                                    <asp:ListItem Text="NO" Value="7"></asp:ListItem>
                                </asp:DropDownList>
